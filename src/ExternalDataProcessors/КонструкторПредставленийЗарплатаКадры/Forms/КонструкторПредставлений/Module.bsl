...
//  Соответствие Из КлючИЗначение, Неопределено - Описания представлений или Неопределено, если кэш недоступен.
//
&НаСервере
...
// Код программного интерфейса представления.
// 
// Параметры:
//  Представление - ДанныеФормыСтруктура - Представление
//  ВыбранныеПоля - Массив Из ДанныеФормыСтруктура - Выбранные поля
//  ВыбранныеПараметры - Массив Из ДанныеФормыСтруктура - Выбранные параметры
// 
// Возвращаемое значение:
//  Строка - Код программного интерфейса представления
&НаСервере
