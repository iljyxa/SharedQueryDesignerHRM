...
Процедура ПредставленияПослеАктивизацииСтроки()
	...
	УстановитьОписаниеСтроки("ГруппаОписаниеПредставления", "НадписьОписаниеПредставления", Представление);
КонецПроцедуры
...
Процедура ПоляПриАктивизацииСтроки(Элемент)
	УстановитьОписаниеСтроки("ГруппаОписаниеПоля", "НадписьОписаниеПоля", Элемент.ТекущиеДанные);
КонецПроцедуры
...
Процедура ПараметрыПриАктивизацииСтроки(Элемент)
	...
	УстановитьОписаниеСтроки("ГруппаОписаниеПараметра", "НадписьОписаниеПараметра", ТекущиеДанные);
...
// Выводит текстовое описание текущей строки представления, поля или параметра в надпись группы,
// расположенной под соответствующей таблицей (или под вкладками — для представления).
...
//  ИмяНадписи - Строка - Имя элемента формы - надписи, в которую выводится текст описания.
...
&НаКлиенте
Процедура УстановитьОписаниеСтроки(ИмяГруппы, ИмяНадписи, ТекущиеДанные)

	Если ТекущиеДанные = Неопределено Тогда
		Элементы.Найти(ИмяГруппы).Видимость = Ложь;
	Иначе
		Элементы.Найти(ИмяГруппы).Видимость = ЗначениеЗаполнено(ТекущиеДанные.Описание);
		Элементы.Найти(ИмяНадписи).Заголовок = ТекущиеДанные.Описание;
	КонецЕсли;
