...
//         ** ПсевдонимыПолейСКД - Соответствие - Ключ и значение - части определения вида "Поле КАК Псевдоним"
...
// Заполняет текстовые описания представлений и их доступных полей.
