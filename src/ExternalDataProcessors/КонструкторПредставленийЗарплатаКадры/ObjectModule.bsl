...
Процедура Импортировать(ОписанияПредставлений) Экспорт
	...
	Для Каждого КлючИзначение Из ОписанияПредставлений Цикл
		...
		Для Каждого ДоступныйПараметр Из Описание.ДоступныеПараметры Цикл
			...
			Параметр.ДоступныеЗначения = МодульОбщегоНазначения.ЗначениеВСтрокуXML(ДоступныйПараметр.ДоступныеЗначения);
		КонецЦикла;
	...
	Для Каждого Представление Из Представления Цикл
		...
		Для Каждого Параметр Из ПараметрыПредставления Цикл
			ДобавитьПараметрПредставления(Описание,
										  ...
										  Параметр.ЗначениеЭтоВыражение,
										  МодульОбщегоНазначения.ЗначениеИзСтрокиXML(Параметр.ДоступныеЗначения),
										  Параметр.Описание);
		КонецЦикла;
...
//	ДоступныеЗначения - СписокЗначений, Неопределено - Доступные значения параметра для выбора пользователем
