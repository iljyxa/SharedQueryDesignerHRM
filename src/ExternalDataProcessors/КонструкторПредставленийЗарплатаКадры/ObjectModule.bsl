...
//  РазрешитьУдалениеСтрокиСПустымПараметром - Булево - Признак разрешения удаления строки шаблона с пустым значением параметра.
//
// Возвращаемое значение:
//  Структура - Добавленный параметр. См. НовоеОписаниеПараметраПрограммногоИнтерфейса
...
//   - Для непоследнего позиционного параметра сохраняется запятая,
//     чтобы сохранить позицию аргумента.
//   - Для последнего параметра удаляется запятая предыдущего аргумента,
//     а ");" переносится в конец предыдущей строки.
//
// Параметры:
//   Шаблон                         - Строка - Текст шаблона.
//   ИмяПараметра                   - Строка - Имя без "<" и ">".
//   ЗначениеПараметра              - Строка, Неопределено - Текст для подстановки.
//   УдалятьСтрокуСПустымПараметром - Булево - Удалять строку, если значение параметра пустое.
//
// Возвращаемое значение:
...
Функция ОбработатьПараметрШаблонаПрограммногоИнтерфейса(Шаблон,
	...
	// Непустое значение подставляется во все вхождения плейсхолдера.
	...
	// Сохраняем исходный вид переводов строк.
...
Процедура ДобавитьОписанияПредставлений_Базовые(ОписанияПредставлений)
	...
	// Описание программного интерфейса. Параметры идентичны СрезПоследних
	Описание.ЕстьПрограммныйИнтерфейс = Истина;
	Описание.ПрограммныйИнтерфейс.Шаблон =
		"ОписаниеФильтра = ЗарплатаКадрыОбщиеНаборыДанных.ОписаниеФильтраДляСоздатьВТИмяРегистра(
		|	""<Фильтр>"", <ИзмеренияФильтра>);
