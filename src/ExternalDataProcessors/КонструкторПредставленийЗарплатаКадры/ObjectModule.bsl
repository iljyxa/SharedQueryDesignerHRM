...
Функция ДобавитьПараметрФильтрПрограммногоИнтерфейса(Описание, ИмяПараметра, Обязательный = Истина)
...
Функция ДобавитьПараметрТолькоРазрешенныеПрограммногоИнтерфейса(Описание, ИмяПараметра, Обязательный = Ложь)
...
//     * ДоступныеТипы - Массив из ОписаниеТипов - список допустимых типов параметра
...
Функция НовоеОписаниеПараметраПрограммногоИнтерфейса()
	...
	Описание.Вставить("ДоступныеТипы", Новый Массив);
...
//
// Возвращаемое значение:
//   Структура - Виды параметров:
//     * ИменаПолей - Строка - идентификатор вида параметра "Имена полей"
//     * Параметр - Строка - идентификатор вида параметра "Параметр"
...
Функция ВидыПараметровПрограммногоИнтерфейса() Экспорт
	...
	Виды.Вставить("Параметр", "Параметр");
	Виды.Вставить("Прочее");
...
Процедура ДобавитьОписанияПредставлений_КадровыйУчет(ОписанияПредставлений)
	...
	ДобавитьПараметрФильтрПрограммногоИнтерфейса(Описание, "Фильтр");
	ДобавитьПараметрТолькоРазрешенныеПрограммногоИнтерфейса(Описание, "ТолькоРазрешенные");
	ДобавитьПараметрИменаПолейПрограммногоИнтерфейса(Описание, "КадровыеДанные", Истина);
	ДобавитьПараметрПрограммногоИнтерфейса(Описание, "ПоляОтбораПериодическихДанных");
	ДобавитьПараметрПрограммногоИнтерфейса(Описание, "ФормироватьСПериодичностьДень", , , "ФормироватьСПериодичностьДень");
